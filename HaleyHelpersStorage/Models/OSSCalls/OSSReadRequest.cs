...
namespace Haley.Models {
    public class OSSReadRequest : IOSSRead {
        ...
        public IOSSControlled Client { get; set; } = new OSSControlled(OSSInfo.DEFAULTNAME);
        public IOSSControlled Module { get; set; } = new OSSControlled(OSSInfo.DEFAULTNAME);
        public IOSSControlled Workspace { get; set; } = new OSSControlled(OSSInfo.DEFAULTNAME,control:OSSControlMode.Guid,parse:OSSParseMode.ParseOrGenerate);
