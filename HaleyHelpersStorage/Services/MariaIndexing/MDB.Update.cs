    ...
    public partial class MariaDBIndexing : IDSSIndexing {
        public async Task<IFeedback> UpdateDocVersionInfo(string moduleCuid, IOSSFileRoute file) {
            ...
            try {
                ...
                await _agw.NonQuery(new AdapterArgs(moduleCuid) { Query = INSTANCE.DOCVERSION.INSERT_INFO }, (ID, file.Id), (SAVENAME, file.SaveAsName), (PATH, file.Path), (SIZE, file.Size));
